...
CERT_MANAGER_VERSION=${CERT_MANAGER_VERSION:-${E2E_CERT_MANAGER_VERSION:-v1.20.2}}
GATEWAY_API_VERSION=${GATEWAY_API_VERSION:-${E2E_GATEWAY_API_VERSION:-v1.5.1}}
PROMETHEUS_OPERATOR_VERSION=${PROMETHEUS_OPERATOR_VERSION:-${E2E_PROMETHEUS_OPERATOR_VERSION:-v0.92.0}}
CALICO_VERSION=${CALICO_VERSION:-${E2E_CALICO_VERSION:-v3.32.0}}
EXTERNAL_SECRETS_VERSION=${EXTERNAL_SECRETS_VERSION:-${E2E_EXTERNAL_SECRETS_VERSION:-v2.6.0}}
VELERO_VERSION=${VELERO_VERSION:-${E2E_VELERO_VERSION:-v1.18.1}}
