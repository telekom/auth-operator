...
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#condition-v1-meta) array_ | Conditions defines current service state of the Role definition<br />All conditions should evaluate to true to signify successful reconciliation |  | Optional: {} <br /> |
